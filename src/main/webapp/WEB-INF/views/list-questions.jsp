                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered table-dark">
                        ...
                        <c:forEach var="question" items="${questions}">
                            ...
                            <c:url var="listLink" value="/admin/question/answers">
                                <c:param name="questionId" value="${question.id}" />
                            </c:url>

                            <tr>
                                <td>
                                    <a href="${listLink}">${question.name}</a>
                                </td>
        ...
        <div class="col col-lg-9">
            ...
            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                ...
                <tr>
                    ...
                    <th class="th-sm">Процент</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach var="answerCountDTO" items="${answerCountDTOs}" >
                    <tr>
                        <td>${answerCountDTO.answerName}</td>
                        <td>${answerCountDTO.countAnswer}</td>
                        <td>${answerCountDTO.percent}%</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
...
<script src="https://cdn.datatables.net/responsive/2.2.3/js/responsive.bootstrap4.min.js"></script></body>
<script>
