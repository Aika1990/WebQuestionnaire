...
//            String fileLocation = path.substring(0, path.length() - 1) + "опрос.xls";
//
...
//            Label headerLabel = new Label(0, 0, "Наименование", headerFormat);
//            sheet.setColumnView(0, 60);
//            sheet.addCell(headerLabel);
//
//            headerLabel = new Label(1, 0, "Количество", headerFormat);
//            sheet.setColumnView(0, 40);
//            sheet.addCell(headerLabel);
//
//            headerLabel = new Label(2, 0, "Процент", headerFormat);
//            sheet.setColumnView(0, 40);
//            sheet.addCell(headerLabel);
//
...
//            Number cellPercent = new Number(2, 2, 20, cellFormat);
//            sheet.addCell(cellNumber);
//
//            workbook.write();
//        } finally {
